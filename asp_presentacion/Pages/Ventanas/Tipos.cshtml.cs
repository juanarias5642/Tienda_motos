...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private ITiposPresentacion? iPresentacion = null;

        public TiposModel(ITiposPresentacion iPresentacion)
        {
            try
            {
        ...
        [BindProperty] public Tipos? Filtro { get; set; }
